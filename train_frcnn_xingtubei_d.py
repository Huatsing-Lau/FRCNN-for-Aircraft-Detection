...
在c的基础上修改：1、rpn改为偏移坐标（参考吴佳祥论文公式4-1），相应的损失函数、ROIpooling也改变；
"""
...
from keras_frcnn import losses_SA_CNN_2 as losses_fn
import keras_frcnn.roi_helpers as roi_helpers
from keras.utils import generic_utils
import os
from keras_frcnn import resnet_SA_CNN_2 as nn #注意这里要改变
...
def train_fasterrcnn():
    ...
    cfg.anchor_box_ratios = [[1,1.2],[1,1],[1.2,1]]#[[1,1.4],[1,0.84],[1,1.17],[1,0.64],[1,1]]
    #cfg.rpn_stride = 8
    cfg.im_size = 512
    cfg.num_epochs = 100
