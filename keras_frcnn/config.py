...
class Config:
    def __init__(self):
        ...
        # anchor box scales
        self.anchor_box_scales = [10,25,35]#[64, 128, 256, 512]

        # anchor box ratios
        self.anchor_box_ratios = [[1.2, 1], [1, 1], [1, 1.2]]#[[0.7, 1], [1, 0.7], [1, 1], [1, 1.4], [1.4, 1]]

        # size to resize the smallest side of the image
        #self.im_size = 512#该数值越大，则网络训练所需的内存越大

        # image channel-wise mean to subtract
        self.img_channel_mean = [135.53461495, 143.76664218, 141.35857198]
        ...
        self.rpn_stride = 8 #basenet对原图的缩放比例
